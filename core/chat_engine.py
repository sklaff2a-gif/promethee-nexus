...
_FICHE_TECHNIQUE = (
    ...
    f"- Tes cerveaux locaux (Ollama) : {CHAT_MODEL} (ton modele generaliste par defaut, "
    "~9-12 milliards de parametres ; bascule du 08/06/2026, ex qwen3.5:9b), "
    "qwen2.5-coder:14b (~14 milliards, pour le code), llama3.2-vision:11b (ta "
    "vision), + tes fine-tunes promethee-security / -architect (le fine-tune "
    "strategist a ete abandonne le 08/06). Renfort cloud : "
